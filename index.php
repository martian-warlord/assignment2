...
<body  onload="rotateEvery(1)">
  ...
  <div class="container">
  <p class="navbar-text navbar-left"><a href="#" class="navbar-link glyphicon glyphicon-align-justify"></a></p>
  </div>
</nav>
    ...
    <div class="panel-heading">
      <h4 class="panel-title ">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
          <span class="glyphicon glyphicon-user btn-circle  btn-lg"></span>
        </a>
      </h4>
    </div>
...
<p> </p>
    ...
    <li>Formally trained @ Interface design, graphic design, and computational design </li>
    ...
    <div class="panel-heading">
      <h4 class="panel-title ">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapseThree">
         <span class="glyphicon glyphicon-barcode btn-circle  btn-lg"></span>
        </a>
      </h4>
    </div>
...
<p> </p>
    ...
    <!-- Tab panes -->
    <div class="tab-content">
      <div class="tab-pane active" id="biz1"><ul>
<li>Creative producer (CAPM, CSM) with over twenty years of success leading creative talent on agile productions 
while coordinating the complex flow of technically detailed time critical elements across multiple boundaries.</li>

<li>Content creation, content production and content administration.</li>

<li>Corporate and independent clients including Sony, Toyota, MTV, ABC, EMI, PBS, A&E, Sega, Avon, Canadian Food Network, 
  Rocket Science, APM, Stargate Studios, Ken Gross Management, Quantum Tracks, Qwerty Prods., Focal Press, House of Blues, 
  Doom Inc., Wordsound Recordings, Gamasutra, Tablet Magazine, Palm d'Or Social Club, Karl Records, Ultraculture, Sniderware, 
  Bello Galactica, Helper Games and GK Photography. </li></ul>
...
<li>Graduate coursework at New York University’s Interactive Telecommunications Program in consumer marketing.  
  ...
  communications law and economics. </li>

<li>MOOC coursework includes content management, gamification, technology entrepreneurship, RFID supply chain management, lean Sigma 6, 
  and finance.
</li></ul>
